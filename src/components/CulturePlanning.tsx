...
const CATEGORY_META: Record<string, { icon: string; color: string; bg: string }> = {
  arrosage:      { icon: '💧', color: '#3b82f6', bg: '#eff6ff' },
  traitement:    { icon: '🧪', color: '#8b5cf6', bg: '#f5f3ff' },
  récolte:       { icon: '🌾', color: '#f59e0b', bg: '#fffbeb' },
  désherbage:    { icon: '🌿', color: '#10b981', bg: '#f0fdf4' },
  fertilisation: { icon: '🪣', color: '#a38a5e', bg: '#fdf8f0' },
  observation:   { icon: '👁️', color: '#6b7280', bg: '#f9fafb' },
  autre:         { icon: '📌', color: '#064e3b', bg: '#f0fdf4' },
};
